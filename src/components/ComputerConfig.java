...
public class ComputerConfig {
  ...
  public static void main(String[] args) {
    ...
    var10000.println("component.component.builder.RAM 1: " + var10001 + ", Capacity: " + ram1.getCapacityGB() + "GB, Price: " + ram1.getPrice() + "$");
    var10000 = System.out;
    var10001 = ram2.getModel();
    var10000.println("component.component.builder.RAM 2: " + var10001 + ", Capacity: " + ram2.getCapacityGB() + "GB, Price: " + ram2.getPrice() + "$");
    var10000 = System.out;
    var10001 = ram3.getModel();
    var10000.println("component.component.builder.RAM 3: " + var10001 + ", Capacity: " + ram3.getCapacityGB() + "GB, Price: " + ram3.getPrice() + "$");
    var10000 = System.out;
    var10001 = ram4.getModel();
    var10000.println("component.component.builder.RAM 4: " + var10001 + ", Capacity: " + ram4.getCapacityGB() + "GB, Price: " + ram4.getPrice() + "$");
    var10000 = System.out;
    var10001 = ram5.getModel();
    var10000.println("component.component.builder.RAM 5: " + var10001 + ", Capacity: " + ram5.getCapacityGB() + "GB, Price: " + ram5.getPrice() + "$");
    var10000 = System.out;
    ...
    var10000.println("component.component.builder.Processor 1: " + var10001 + ", Price: " + processor1.getPrice() + "$");
    var10000 = System.out;
    var10001 = processor2.getModel();
    var10000.println("component.component.builder.Processor 2: " + var10001 + ", Price: " + processor2.getPrice() + "$");
    var10000 = System.out;
    var10001 = processor5.getModel();
    var10000.println("component.component.builder.Processor 3: " + var10001 + ", Price: " + processor3.getPrice() + "$");
    var10000 = System.out;
    var10001 = processor4.getModel();
    var10000.println("component.component.builder.Processor 4: " + var10001 + ", Price: " + processor4.getPrice() + "$");
    var10000 = System.out;
    var10001 = processor5.getModel();
    var10000.println("component.component.builder.Processor 5: " + var10001 + ", Price: " + processor5.getPrice() + "$");
    var10000 = System.out;
    var10001 = motherboard1.getModel();
    var10000.println("component.component.builder.Motherboard 1: " + var10001 + ", Price: " + motherboard1.getPrice() + "$");
    var10000 = System.out;
    var10001 = motherboard2.getModel();
    var10000.println("component.component.builder.Motherboard 2: " + var10001 + ", Price: " + motherboard2.getPrice() + "$");
    var10000 = System.out;
    var10001 = motherboard3.getModel();
    var10000.println("component.component.builder.Motherboard 3: " + var10001 + ", Price: " + motherboard3.getPrice() + "$");
    var10000 = System.out;
    var10001 = motherboard4.getModel();
    var10000.println("component.component.builder.Motherboard 4: " + var10001 + ", Price: " + motherboard4.getPrice() + "$");
    var10000 = System.out;
    var10001 = motherboard5.getModel();
    var10000.println("component.component.builder.Motherboard 5: " + var10001 + ", Price: " + motherboard5.getPrice() + "$");
    ...
    System.out.println("Select a component.component.builder.Motherboard:");
    ...
    System.out.print("Enter the number of the selected component.component.builder.Motherboard: ");
    ...
    var10000.println("Selected component.component.builder.Motherboard: " + var10001 + ", SocketType: " + chosenMotherboard.getSocketType() + ", Price: " + chosenMotherboard.getPrice());
    System.out.println("Select a component.component.builder.Processor:");
    ...
    while(chosenProcessor == null || chosenMotherboard.getSocketType().equals("LGA1200") && chosenProcessor.getTypeClass().equals("AMD")) {
      System.out.print("Enter the number of the selected component.component.builder.Processor: ");
    ...
    var10000.println("Selected component.component.builder.Processor: " + var10001 + ", Price: " + chosenProcessor.getPrice());
    ...
    System.out.println("Select a component.component.builder.RAM:");
    ...
    System.out.print("Enter the number of the selected component.component.builder.RAM: ");
    ...
    System.out.println("Enter count of component.component.builder.RAM: ");
    ...
    while(true) {
      while(scanner.hasNextInt()) {
        ...
        if (userCountRAMInput <= chosenMotherboard.getRamCountSlot()) {
          ...
          var10000.println("Selected component.component.builder.RAM: " + var10001 + ", Capacity: " + chosenRAM.getCapacityGB() + "GB, Price: " + chosenRAM.getPrice() * (double)userCountRAMInput);
        ...
        System.out.println("Count of component.component.builder.RAM exceeds the number of motherboard component.component.builder.RAM slots. Please enter a valid count.");
      }
